...
Way back when you built your first app, you went over builtin directives.  These are directives that angular comes with like `ng-repeat`.  In this lesson, we're going to build our own custom directives. But first...
